...
const videoArr=[
  ...
  return (
    ...
    <Heading>Sample Video1</Heading>
    <Text>This is a Sample videos for testing and demos. please it as demo.
    YouTube descriptions should always include a call to action. Ask your viewers to subscribe, comment, like, and read more. You can also include affiliate links, social media handles, more videos, and website links for viewers to click.
    ...
    {videoArr.map((items,index)=>(
        <Button varient ={'ghost'} colorScheme={'purple'} onClick={()=>setVideoSrc(items)}>
